...
catalog_tags = ('## Κατάλογος Πινάκων','## ΚΑΤΑΛΟΓΟΣ ΣΧΗΜΑΤΩΝ','## ΚΑΤΑΛΟΓΟΣ ΕΙΚΟΝΩΝ','## ΚΑΤΑΛΟΓΟΣ ΠΙΝΑΚΩΝ','## Κατάλογος Εικόνων','## Κατάλογος Σχημάτων', '## Πίνακας Διαγραμμάτων', '## ΚΑΤΑΛΟΓΟΣ ΣΧΗΜΑΤΩΝ' )
